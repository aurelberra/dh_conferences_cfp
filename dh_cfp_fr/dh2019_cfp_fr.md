...
Le thème du colloque 2019 est « Complexités ». Ce thème offre des connections multiples avec la recherche en humanités numériques (HN). _Complexités_ invite les personnes à se concentrer sur les HN en tant qu'approche humaniste de construction de modèles complexes de réalités complexes, usant de méthodes computationnelles pour les analyser, puis pour les divulguer à un plus large public. Le thème invite également à s'interroger sur les complexités et diversités théoriques, sociales et culturelles dans lesquelles évoluent la recherche en humanités numériques, et demande à notre communauté de dialoguer avec conscience et sens critique, dans une multitude de directions, par le biais de la conférence ainsi que via les réseaux, institutions et entreprises intéressés dans la recherche en HN. Enfin, ce thème signifie impliquer les générations futures, et enseigner les HN aux étudiants – les personnes qui auront à traiter avec les _complexités_ du monde futur.

Nous vous encourageons tout particulièrement à soumettre des contributions qui abordent ce thème, mais seront également acceptées à la Conférence des propositions qui auront trait à tout aspect ou champ des humanités numériques. Cet appel concerne notamment, mais non exclusivement :

- les aspects théoriques, épistémologiques, méthodologiques et historiques des humanités numériques ;
- les approches et applications informatiques et numériques dans les études littéraires et la linguistique, dont les études textuelles numériques, la stylométrie, l'attribution d'auteur, la fouille de texte, le traitement automatique du langage naturel, la linguistique computationnelle, la philologie numérique et l'édition de texte numérique ;
...
- approches numériques en musique, cinéma, théâtre, nouveaux médias ; arts et littératures numériques, jeux vidéo, la culture _hacker_, les communautés en réseau, les fractures numériques, l'activisme numérique, les réseaux et logiciels ouverts ou libres, etc. ;
- le patrimoine culturel, les _cultural studies_ numériques et les recherches entreprises par des institutions culturelles numériques ;
- les aspects sociaux, culturels et politiques des humanités numériques, dont les féminismes numériques, les études indigènes numériques, les études culturelles et ethniques numériques, les études noires numériques, les études _queer_ numériques, les études géopolitiques numériques, le multiculturalisme et le multilinguisme en HN, l'éco-critique et l'humanisme écologique et leurs rapport avec les HN.
- les technologies émergentes telles que le _physical computing_, les ordinateurs monocartes, le _minimal computing_, les technologies portables (_wearable devices_) ou haptiques, en tant que ces technologies sont appliquées à la recherche en sciences humaines ;
- les aspects institutionnels des HN, les aspects interdisciplinaires de la discipline, la science ouverte, les _public humanities_, l'engagement social et l'impact des HN ;
- les humanités numériques dans la pédagogie et les formations universitaires ;
- les infrastructures de recherche en HN, les bibliothèques numériques, les environnements de recherche virtuels, l'archéologie des médias, etc. ;
- ainsi que tout autre thème ayant un lien pertinent avec les humanités numériques.

Le colloque se tiendra officiellement en anglais, mais nous encourageons également les propositions faites dans d'autres langues pour lesquelles nous avons un nombre d'évaluateurs suffisant (allemand, espagnol, français, italien, et portugais).
...
**DH2019 utilisera une évaluation par les pairs en double-aveugle. Afin d'en faciliter le processus, il est demandé aux auteurs de supprimer toute information qui pourrait les identifier, comme noms, affiliations, URLs de projets, etc.**
...
- les supports matériels et logiciels qui seront nécessaires aux participants (la conférence prendra en charge le support technique traditionnel, mais les organisateurs d'ateliers sont tenus de prendre en charge les besoins spécifiques, comme les accès à des logiciels, serveurs, etc.) ;
...
**Représentant aaDH :** Paul Arthur

**Représentant aaDH :** Simon Musgrave

**Représentante ACH :** Meghan Ferriter

**Représentant ACH :** Thomas Padilla

**Représentante centerNet :** Francesca Benatti

**Représentante centerNet :** Nirmala Menon

**Représentante CSDH/SCHN :** Maureen Engel

**Représentant CSDH/SCHN :** Michael Ullyot

**Représentante EADH :** Claire Clivaz

**Représentant EADH :** Christian-Emil Ore

**Représentante Humanistica :** Clarisse Bardiot

**Représentant Humanistica :** Vincent Razanajao

**Représentant JADH :** Akihiro Kawase

**Représentant JADH :** Taizo Yamada